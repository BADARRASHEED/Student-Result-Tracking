...
- Rich SQLite seed data: 15 users, 3 classes, 15 students, 8 subjects, multiple assessments and marks for realistic analytics.
...
- **Students**: amelia.student@example.com, benjamin.student@example.com, chloe.student@example.com, daniel.student@example.com, ella.student@example.com, felix.student@example.com, grace.student@example.com, hannah.student@example.com (Password@123)

Log in with any account to explore dashboard metrics, student directories, analytics, and PDF report cards.
